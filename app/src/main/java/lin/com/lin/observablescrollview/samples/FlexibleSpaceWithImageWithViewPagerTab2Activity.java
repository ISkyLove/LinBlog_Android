 ...
 */
public class FlexibleSpaceWithImageWithViewPagerTab2Activity extends ObserverBaseActivity implements ObservableScrollViewCallbacks {
    ...
    private TouchInterceptionFrameLayout.TouchInterceptionListener mInterceptionListener = new TouchInterceptionFrameLayout.TouchInterceptionListener() {
        ...
        public void onDownMotionEvent(MotionEvent ev) {
            ...
            mBaseTranslationY = ViewCompat.getTranslationY(mInterceptionLayout);
        ...
        public void onMoveMotionEvent(MotionEvent ev, float diffX, float diffY) {
            int flexibleSpace = mFlexibleSpaceHeight - mTabHeight;
            float translationY = ScrollUtils.getFloat(ViewCompat.getTranslationY(mInterceptionLayout) + diffY, -flexibleSpace, 0);
        ...
        public void onUpOrCancelMotionEvent(MotionEvent ev) {
            ...
            mScroller.forceFinished(true);
            int baseTranslationY = (int) ViewCompat.getTranslationY(mInterceptionLayout);
    ...
    private void updateFlexibleSpace() {
        updateFlexibleSpace(ViewCompat.getTranslationY(mInterceptionLayout));
    }
    ...
    private void updateFlexibleSpace(float translationY) {
        ...
        ViewCompat.setTranslationY(mImageView, ScrollUtils.getFloat(-translationY / 2, minOverlayTransitionY, 0));

        // Change alpha of overlay
        float flexibleRange = mFlexibleSpaceHeight - getActionBarSize();
        ViewCompat.setAlpha(mOverlayView, ScrollUtils.getFloat(-translationY / flexibleRange, 0, 1));
