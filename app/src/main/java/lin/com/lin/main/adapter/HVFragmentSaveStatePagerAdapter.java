...
public class HVFragmentSaveStatePagerAdapter extends PagerAdapter {
	...
	public HVFragmentSaveStatePagerAdapter(FragmentManager fragmentManager,
			ViewPager viewPager, List<LBaseFragment> fragments) {
